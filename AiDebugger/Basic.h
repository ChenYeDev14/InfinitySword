...
namespace DS14
{
    ...
    const int MISSLE_POWER_REDUCE = 5; //Harm = 20-5%*distance
	const int MISSLE_ORIGIN_SPEED = 600;
    const int MISSLE_ORIGIN_RADIUS = 150;
    ...
    const double MISSLE_DAMAGE_PER_STENTH = 0.5;
