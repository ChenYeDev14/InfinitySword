...
public:
    ...
    void WriteInitialInfo(const PlayerInfo &playerInfo1, const PlayerInfo &playerInfo2);
            //写入初始信息（玩家，地图）
    ...
    //以下函数默认文件打开成功
    void ReadInitialInfo(PlayerInfo &playerInfo1, PlayerInfo &playerInfo2); //读出初始信息
